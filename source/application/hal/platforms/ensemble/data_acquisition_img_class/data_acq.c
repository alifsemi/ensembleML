...
int data_acq_channel_init(data_acq_module* module)
{
    ...
    /* Initialise the data acquisition interface based on the use case */
    module->system_init = init_data_acq_img_class;
    module->get_data = get_data_img_class;

    strncpy(module->system_name, "Ensemble", sizeof(module->system_name));
